...
class TestProportions:
    ...
    data = pd.read_excel(r'./tests/test_data/testdata_Proportion.xlsx', sheet_name = 'testdata_Prop').iloc[:,:-1]
    data_group = pd.read_excel(r'./tests/test_data/testdata_Proportion.xlsx', sheet_name = 'testdata_Prop_g').iloc[:,:-1]
